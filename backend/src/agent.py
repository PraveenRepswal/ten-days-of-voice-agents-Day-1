...
DEFAULT_FAQ = [
    ...
    },
    {
        ...
        "answer": "Yes! Mr. Pankaj releases weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Mr. Pankaj Store'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Mr. Pankaj and email you." (Don't hallucinate prices).
            """,
