...
async def start_adventure(
    ...
    player_name: Annotated[str, Field(description="The player's name. You must ask for this if not known.")],
) -> str:
    ...
    opening = (
        f"Greetings {userdata.player_name}. Welcome to '{WORLD['intro']['title']}'.\n\n"
...
class GameMasterAgent(Agent):
    def __init__(self):
        ...
        Rules:
            - You MUST ask for and obtain the player's name BEFORE calling `start_adventure`.
            - Use `start_adventure` to begin once you have the name.
            - Use `player_action` for all other moves.
